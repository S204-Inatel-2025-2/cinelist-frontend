describe('Testes Cadastro', () => {
  it('Teste cadastro com sucesso', () => {
  const nome = `User_${Math.random().toString(36).substring(2, 7)}`
  const email = `${nome}@teste.com`
  const senha = 'senha123'
  cy.visit('https://mycinelist.vercel.app/login')
  cy.get('.text-slate-600 > .text-blue-600').click()
  cy.get(':nth-child(1) > .relative > .w-full').type(nome)
  cy.get(':nth-child(2) > .relative > .w-full').type(email)
  cy.get(':nth-child(3) > .relative > .w-full').type(senha)
  ...
  it('Teste cadastro com email já existente', () => {
  cy.visit('https://mycinelist.vercel.app/login')
  cy.get('.text-slate-600 > .text-blue-600').click()
  cy.get(':nth-child(1) > .relative > .w-full').type('Falcon')
  cy.get(':nth-child(2) > .relative > .w-full').type('falcon@gmail.com')
  cy.get(':nth-child(3) > .relative > .w-full').type('senha123')
  cy.get('.bg-blue-600').click()
  // ✅ Verificações
  cy.contains('Email já cadastrado').should('be.visible') // verifica texto esperado
  cy.wait(3000) // espera 2 segundos
  })
  it('Teste cadastro com email inválido', () => {
  cy.visit('https://mycinelist.vercel.app/login')
  cy.get('.text-slate-600 > .text-blue-600').click()
  cy.get(':nth-child(1) > .relative > .w-full').type('Falcon')
  cy.get(':nth-child(2) > .relative > .w-full').type('falcongmail.com')
  cy.get(':nth-child(3) > .relative > .w-full').type('senha123')
  cy.get('.bg-blue-600').click()
  // ✅ Verificações
  cy.url().should('include', '/register') // ainda deve estar na página de login
  cy.wait(3000) // espera 2 segundos
  })
  it('Teste cadastro com campos incompletos', () => {
  cy.visit('https://mycinelist.vercel.app/login')
  cy.get('.text-slate-600 > .text-blue-600').click()
  cy.get(':nth-child(1) > .relative > .w-full').type('Falcon')
  cy.get('.bg-blue-600').click()
...
describe('Testes login', () => {
  ...
  cy.visit('https://mycinelist.vercel.app/login')
  cy.get(':nth-child(1) > .relative > .w-full').type('falcon@gmail.com')
...
describe('Testes Avaliações', () => {
  ...
  // ✅ Verificações
  cy.contains('Movie já foi avaliado por este usuário.').should('be.visible') // verifica texto esperado
  cy.wait(3000) // espera 2 segundos
})
  ...
  cy.get('.bg-blue-600').click()
  cy.wait(5000) // espera 5 segundos
  cy.visit('https://mycinelist.vercel.app/profile')
  cy.wait(2000) // espera 2 segundos
  cy.get(':nth-child(1) > .p-4 > .mt-auto > .w-full').click()
  cy.wait(2000) // espera 2 segundos
  cy.get('.space-y-4 > :nth-child(2) > .w-full').type('Vi de novo e achei marromeno')
  cy.get('.bg-blue-600').click()
  cy.wait(2000) // espera 2 segundos
  // ✅ Verificações
  ...
  cy.get('.space-y-4 > :nth-child(2) > .w-full').type('Descrição da lista da DALVA')
  ...
  cy.wait(2000) // espera 2 segundos
  cy.get('.mt-8 > .relative > .w-full').type('Breaking Bad')
  ...
  cy.wait(2000) // espera 2 segundos
  cy.get('.mt-8 > .relative > .w-full').type('Death Note')
  cy.get('.right-2').click()
  cy.wait(2000) // espera 2 segundos
  cy.get(':nth-child(1) > .p-4 > .space-x-2 > .bg-slate-200').click()
  cy.get('li > .w-full').click()
  ...
  cy.wait(2000) // espera 2 segundos
  cy.get('.mt-8 > .relative > .w-full').type('Nossa Culpa')
  cy.get('.right-2').click()
  cy.wait(2000) // espera 2 segundos
  cy.get(':nth-child(1) > .p-4 > .space-x-2 > .bg-slate-200').click()
  cy.get('li > .w-full').click()
  ...
  cy.get(':nth-child(1) > .p-4 > .space-x-2 > .bg-slate-200').click()
  cy.get('li > .w-full').click()
  cy.contains('Adicionar à Lista').should('be.visible')
  cy.wait(3000) // espera 2 segundos
  })
